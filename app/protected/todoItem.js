...
const TodoItem = ({ id, text }) => {
  ...
  return (
    <li>
      <div className="p-4 m-4 w-auto border rounded-lg bg-gray-900 hover:bg-gray-800 flex items-center justify-between">
        ...
        <div className="flex items-center">
          ...
          />
          <label htmlFor={`todo-${id}`} className="ml-2 text-gray-200">
            Completed
          </label>
        </div>
